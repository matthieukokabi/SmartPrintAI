...
const nextConfig = {
    ...
    async redirects() {
          return [
            { source: '/products/cmmtjreet000oqwl2x138srq7', destination: '/products', permanent: true },
            { source: '/products/cmmtjnf3f0006qwl2outzyuu1', destination: '/products', permanent: true },
            { source: '/products/cmmtjrkl8000pqwl2sgjrhftq', destination: '/products', permanent: true },
                ]
    },
    async headers() {
          return [
