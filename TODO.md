...
- [ ] Set up Make.com automations (phase 1 delivered on 2026-03-11: `order_alert`, `shipped_review_request`, secured `daily_digest` trigger route + runbook `docs/marketing/MAKE_AUTOMATIONS_SETUP.md`; remaining: abandoned cart, design auto-post)
