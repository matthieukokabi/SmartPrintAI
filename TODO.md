...
- [ ] Set up Make.com automations (app-side wiring complete on 2026-03-11 for all 5 flows: `order_alert`, `shipped_review_request`, `abandoned_cart_candidate`, secured `daily_digest`, `design_auto_post`; runbook `docs/marketing/MAKE_AUTOMATIONS_SETUP.md`; pending manual Make scenario activation/tuning)
