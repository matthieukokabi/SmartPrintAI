...
export default function Hero({ copy = defaultCopy }: HeroProps) {
    ...
    return (
        <section className="relative overflow-hidden pb-20 pt-8 sm:pb-24 sm:pt-10 lg:pb-28">
            ...
            <div className="relative z-10 mx-auto grid max-w-7xl gap-14 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8">
                <div className="max-w-2xl">
                    ...
                    <h1 className="mt-8 text-5xl font-semibold leading-[0.98] tracking-[-0.04em] sm:text-6xl lg:text-7xl xl:text-[5.4rem]">
                        {copy.titleLead}
                        <span className="font-editorial text-gradient mx-3 inline-block">{copy.titleAccent}</span>
                        <span className="block">{copy.titleTail}</span>
                    </h1>

                    <p className="premium-muted mt-6 max-w-xl text-base leading-7 sm:text-lg sm:leading-8">
                        {copy.subtitle}
                    </p>

                    <div className="premium-panel mt-10 rounded-[2rem] p-3 sm:p-4">
                        <div className="premium-inputShell flex flex-col overflow-hidden rounded-[1.5rem] p-2 shadow-[0_14px_38px_-26px_rgba(0,0,0,0.45)] sm:flex-row sm:items-center">
                            <input
                                type="text"
                                value={prompt}
                                ...
                                className="premium-input min-h-[3.5rem] flex-1 px-4 text-base outline-none sm:px-5"
                            />
                            <button
                                onClick={handleCreate}
                                className="premium-primaryButton inline-flex items-center justify-center gap-2 rounded-[1.2rem] px-5 py-3 text-sm font-semibold transition-transform duration-300 sm:px-6"
                            >
                                {copy.createButton}
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                            {copy.samplePrompts.map((sample) => (
                                <button
                                    ...
                                    className="premium-chip rounded-full px-3.5 py-2 text-left text-xs leading-5 transition-colors hover:text-[hsl(var(--premium-ink))]"
                                >
                                    {sample}
                                </button>
                            ))}
                ...
                <div className="relative lg:pl-8">
                    <div className="premium-panel relative rounded-[2.4rem] p-5 sm:p-6 lg:sticky lg:top-28">
                        ...
                        <div className="premium-panel-soft rounded-[1.6rem] p-4">
                            ...
                            <p className="mt-4 max-w-md text-sm leading-6 text-[hsl(var(--premium-ink))] sm:text-[15px]">
                                {activePrompt}
                            </p>
                        </div>

                        <div className="mt-4 grid grid-cols-[1.1fr_0.9fr] gap-4">
                            <div className="premium-panel-soft flex aspect-[4/5] flex-col justify-between rounded-[1.8rem] p-5">
                                <div className="flex items-center justify-between">
                                    <Sparkles className="h-5 w-5 text-[hsl(var(--premium-spot))]" />
                                    <div className="h-10 w-10 rounded-full bg-[radial-gradient(circle,hsl(var(--premium-spot-alt)/0.4),transparent_68%)]" />
                                </div>
                                <div className="space-y-4">
                                    <div className="rounded-[1.5rem] border border-[hsl(var(--premium-line)/0.6)] bg-[radial-gradient(circle_at_top,hsl(var(--premium-spot-alt)/0.18),transparent_58%),linear-gradient(160deg,hsl(var(--premium-surface))_0%,transparent_100%)] p-4">
                                        <div className="aspect-[4/5] rounded-[1.25rem] bg-[linear-gradient(180deg,hsl(var(--premium-surface-soft))_0%,transparent_100%),radial-gradient(circle_at_25%_20%,hsl(var(--premium-spot)/0.28),transparent_32%),radial-gradient(circle_at_70%_28%,hsl(var(--premium-spot-alt)/0.24),transparent_34%)]" />
                                    </div>
                            ...
                            <div className="grid gap-4">
                                ...
                                <div className="premium-panel-soft flex aspect-[4/5] flex-col justify-between rounded-[1.6rem] p-4">
