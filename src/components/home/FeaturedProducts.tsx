    ...
    return (
        <section className="relative py-24 sm:py-28">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                {featured.length === 0 ? (
                    <div className="premium-panel mx-auto mt-14 max-w-3xl rounded-[2rem] p-10 text-center">
                            ...
                            return (
                                ...
                                >
                                    <Link
                                        ...
                                        className={`premium-panel group block overflow-hidden rounded-[2rem] transition-transform duration-300 hover:-translate-y-1 ${isLeadCard ? 'sm:col-span-2 xl:grid xl:grid-cols-[1.05fr_0.95fr]' : ''}`}
                                    >
                                        <div className={`relative overflow-hidden ${isLeadCard ? 'aspect-[5/4] xl:aspect-auto xl:min-h-[24rem]' : 'aspect-[4/5]'}`}>
                                            {product.imageUrl ? (
                                                <Image
