...
// Returns true only when the product has a real user-uploadable design image
function hasUserDesign(product: Awaited<ReturnType<typeof getProduct>>): boolean {
...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  const indexable = hasUserDesign(product)
  ...
  return {
          ...
          alternates: {
                    ...
                    languages: {
                                ...
                                fr: `${SITE_URL}/fr/products/${product.id}`,
                                de: `${SITE_URL}/de/products/${product.id}`,
                                es: `${SITE_URL}/es/products/${product.id}`,
                    },
          },
