...
describe('homepage brand v2 regression', () => {
    it('keeps premium conversion section structure in homepage component', () => {
        ...
        expect(source).toContain('resolveHomepageHeroVariant')
        expect(source).toContain('data-page-variant={heroPageVariant}')
        ...
        expect(source).toContain('heroAssurancesVariantB')
